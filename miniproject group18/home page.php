...
<body>
  ...
  <div class="full">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown dropdown">
              <a class="nav-link " href="rooms.php"  role="button">
                Book a Room
              </a>
    ...
    <div class="card-deck car  ">
      <div class="card shadow-lg p-3 mb-5 bg-white rounded ">
        <div class="clor">
          <img src="images/u1.png" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title"> A. Krasinsky: Marlboro</h5>
            <p class="card-text">Many thanks for the wonderful service and kindness extended to our group. We will
              recommend the Anchorage Grand Hotel every time!</p>
      ...
      <div class="card shadow-lg p-3 mb-5 bg-white rounded">
        <div class="clor">
          <img src="images/u2.png" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">G. Gonzalez: Anchorage</h5>
            <p class="card-text">It was just so comfortable... I will stay here on my next trip. I loved the room, which
              was homey and made me feel like I was not so far away.</p>
            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
          </div>
        </div>
      </div>
      <div class="card shadow-lg p-3 mb-5 bg-white rounded">
        <div class="clor">
          <img src="images/u3.png" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">L Bailey: Seward</h5>
            <p class="card-text">Exceeds my expectations. It was a pleasant and enjoyable stay. Thank you for making our
              stay in your hotel a pleasant and enjoyable one.</p>
            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
          </div>
        </div>
      </div>
